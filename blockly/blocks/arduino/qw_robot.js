...
Blockly.Blocks.df_analog_co2 = {
  init: function() {
    this.setColour(Blockly.Blocks.dfrobot.HUE);
    this.appendDummyInput("")
        .appendField(Blockly.MIXLY_CO2)		
...
//IIC颜色传感器 TCS34725 启动测量
Blockly.Blocks.df_SEN0212_TCS34725_start={
init:function(){
    this.setColour(Blockly.Blocks.dfrobot.HUE);
    this.appendDummyInput("")
    .appendField("颜色传感器（TCS34725） 测量一次");
    this.setInputsInline(true);
    this.setPreviousStatement(true);
    this.setNextStatement(true);
  }
};
//IIC颜色传感器 TCS34725 获取结果
var DF_TCS34725=[["红色值", "1"],["绿色值", "2"],["蓝色值", "3"]];

Blockly.Blocks.df_SEN0212_TCS34725_get = {
  init: function() {
    this.setColour(Blockly.Blocks.dfrobot.HUE);
    this.appendDummyInput("")
        .appendField("颜色传感器（TCS34725）读取结果")
        .appendField(new Blockly.FieldDropdown(DF_TCS34725), "SELECT");
  this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('需要先测量一次，再取结果');
  }
};
...
Blockly.Blocks.df_temperature = {
  init: function() {
    ...
    .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_temperature.png", 47, 32));
  this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
  this.setInputsInline(true);
...
Blockly.Blocks.df_led = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_led.png", 43, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.appendDummyInput("")
...
Blockly.Blocks.df_buzzer = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_buzzer.png", 39, 32));   	
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.appendDummyInput("")
...
Blockly.Blocks.df_btn = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_btn.png", 37, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
...
Blockly.Blocks.df_vibration = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_vibration.png", 38, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
    this.setOutput(true, Boolean);
...
Blockly.Blocks.df_tilt = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_tilt.png", 41, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
    this.setOutput(true, Boolean);
...
Blockly.Blocks.df_touch = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_touch.png", 41, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
    this.setOutput(true, Boolean);
...
Blockly.Blocks.df_magnetic = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_magnetic.png", 36, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
    this.setOutput(true, Boolean);
...
Blockly.Blocks.df_pyroelectric_infrared = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_pyroelectric_infrared.png", 41, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
    this.setOutput(true, Boolean);
...
Blockly.Blocks.df_joystick_d = {
  init: function() {
    ...
    this.appendDummyInput("")
		  ...
		  .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_joystick.png", 35, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
    this.setOutput(true, Boolean);
...
Blockly.Blocks.df_potentiometer = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_potentiometer.png", 42, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_rotation = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_rotation.png", 42, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_voltage = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_voltage.png", 39, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_piezo_disk_virbration = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_piezo_disk_virbration.png", 57, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_sound = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_sound.png", 37, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_light = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_light.png", 40, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_grayscale = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_grayscale.png", 46, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_flame = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_flame.png", 41, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_accelerometer = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_accelerometer.png", 39, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_moisture = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_moisture.png", 79, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_water = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_water.png", 51, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_co = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_co.png", 37, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_Sharp_GP2Y0A21 = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_Sharp_GP2Y0A21.png", 38, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.setInputsInline(true);
...
Blockly.Blocks.df_relay = {
  init: function() {
    ...
    this.appendDummyInput("")
		...
		.appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_relay.png", 37, 32));
	this.appendValueInput("PIN", Number)
        .appendField(Blockly.MIXLY_PIN)
        .setCheck(Number);
	this.appendDummyInput("")	
...
Blockly.Blocks.df_lcd_print = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage("./libraries/ThirdParty/dfrobot/media/dfrobot/df_lcd.png", 70, 32));
    this.appendValueInput("TEXT", String)
        .setCheck([String,Number])
        .setAlign(Blockly.ALIGN_RIGHT)
