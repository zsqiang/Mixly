...
Blockly.Arduino.servo_move1 = function () {
  ...
  if(mode==1)
  {
  Blockly.Arduino.definitions_['include_Servo'] = '#include <Timer2ServoPwm.h>';
  Blockly.Arduino.definitions_['var_declare_servo' + dropdown_pin] = 'Timer2Servo servo_' + dropdown_pin + ';';
  }
  Blockly.Arduino.setups_['setup_servo_' + dropdown_pin] = 'servo_' + dropdown_pin + '.attach(' + dropdown_pin + ');';
  var code = 'servo_' + dropdown_pin + '.write(' + value_degree + ');\n' + 'delay(' + delay_time + ');\n';
  return code;
